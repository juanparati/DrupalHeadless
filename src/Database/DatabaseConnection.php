...
abstract class DatabaseConnection extends \PDO {
     ...
     * @var string
     */
    protected $statementClass = '\\DrupalHeadless\\Database\\DatabaseStatementBase';
     ...
     */
    public function getDriverClass($class, $use_autoload = TRUE) {

        if (empty($this->driverClasses[$class])) {
            $driver = $this->driver();
            $this->driverClasses[$class] = 'DrupalHeadless\\Database\\' . ucfirst($driver) . '\\' . $class . 'Driver';
            
            // Search in parent namespace
            if (!class_exists($this->driverClasses[$class], $use_autoload))
                $this->driverClasses[$class] = 'DrupalHeadless\\Database\\' . $class;
