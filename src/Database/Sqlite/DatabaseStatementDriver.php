...
use DrupalHeadless\Database\DatabaseStatementPrefetch;
use DrupalHeadless\Database\DatabaseStatementInterface;
 ...
 */
class DatabaseStatementDriver extends DatabaseStatementPrefetch implements \Iterator, DatabaseStatementInterface {
